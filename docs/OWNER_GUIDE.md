...
4. They pick a mock series and **pay ₹249 once** — this unlocks that series **forever** (not a per-attempt fee). Two are pre-loaded today: **UPSC Prelims GS Paper I — Mock Series (1000 papers)** and **UPSC Prelims CSAT — Mock Series**, each ₹249.
5. They sit a mock paper built to match the real UPSC exam (timing, marking scheme, question count) — not a short quiz — and can retake as many of the 1,000 papers as they like, unlimited, forever, from that one payment.
