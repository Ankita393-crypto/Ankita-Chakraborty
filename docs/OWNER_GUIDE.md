...
4. They pick a mock series and **pay ₹249 once** — this unlocks that series **forever** (not a per-attempt fee). Two are pre-loaded today: **UPSC Prelims GS Paper I** and **UPSC Prelims CSAT**, each ₹249. (The old "1000 papers" number is retired everywhere — the promise you decided on (31 Aug 2026) is **"unlimited retakes from a growing bank of verified questions"**, and the screens now show the honest paper count for each series alongside a note that papers share questions while the bank is small.)
