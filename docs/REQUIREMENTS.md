...
**Still open after the latest owner review:** the free-tier daily generation cap [OQ-7] (premium tier itself is now **parked**, not merely deferred — product plan Decision #18, so FR-29/FR-30 are inactive until the owner revisits it); the Mains regional-language list (product plan Decision #23); mock-attempt certificates (product plan Decision #24); wrong-answer-key remediation policy (Decision #26); final public wording of the product claim replacing "1,000 papers" (Decision #27); and whether GS Paper I ships in v1 at all (Decision #28) — see product plan Section 13. Operational prerequisites that remain are tasks, not decisions: domain/trademark check for "Bodhi", payment gateway individual onboarding, YouTube channel creation, and Privacy Policy / Terms of Service drafting.
